        ...
        <form class="container px-6 mx-auto grid" method="post" action="/admin/profil/update/{{ Auth::user()->id }}">
          ...
          <div >
            ...
            <div class="mb-6 flex items-center">
              ...
              <input type="text" id="password" name="password" class="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{(Auth::user()->password)}}"/>
