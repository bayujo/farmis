    ...
    <div class="py-4 text-gray-500">
      ...
      <ul class="mt-6">
        ...
        <li class="relative px-6 py-3">
          ...
          @endif
          <a
            class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 @if(Route::current()->getName() == 'admin.home') text-gray-800 @endif"
            href="/admin/home"
          >
            <svg
              class="w-5 h-5"
      ...
      <ul>
        <li class="relative px-6 py-3">
          @if(Route::current()->getName() == 'admin.sapi')
          <span
                class="absolute inset-y-0 left-0 w-1 bg-indigo-600 rounded-tr-lg rounded-br-lg"
                aria-hidden="true"
          ></span>
          ...
          @endif
          <a
            class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 @if(Route::current()->getName() == 'admin.sapi') text-gray-800 @endif"
            href="/admin/sapi"
          >
            <svg
              class="w-5 h-5"
        ...
        <li class="relative px-6 py-3">
          @if(Route::current()->getName() == 'admin.penjadwalan')
          <span
                class="absolute inset-y-0 left-0 w-1 bg-indigo-600 rounded-tr-lg rounded-br-lg"
                aria-hidden="true"
          ></span>
          ...
          @endif
          <a
            class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 @if(Route::current()->getName() == 'admin.penjadwalan') text-gray-800 @endif"
